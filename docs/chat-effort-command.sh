...
# Requires a complete local checkpoint; see chat-reasoning-effort.md.
docker run --rm --gpus '"device=0,1"' --ipc=host -p 127.0.0.1:30000:30000 \
  ...
  --entrypoint python3 docker.io/kanadaj/sglang-qwen38fn-sm120-turbo:production-chat-effort-20260913-v2@sha256:872a2bda228e39aa9c1af729b47cc28f7862e7859e448f1a8868b85a4051f404 -m sglang.launch_server \
  --model-path \
  /model \
  --enable-metrics \
