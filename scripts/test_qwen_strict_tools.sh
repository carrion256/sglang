...
run docker run --rm --pull never --network none --memory 8g --cpus 3 \
  ...
  'python3 /repo/tests/runtime_qwen_strict_tools.py -q && python3 /repo/tests/runtime_qwen_effort_alias.py -q && python3 /repo/validation/responses/runtime_stream_stability.py -q'
